...
function parseString(string) {
  ...
  return (m = regexps.reHex3.exec(string)) ? (m = parseInt(m[1], 16), rgbaToHsla((m >> 8 & 0xf) | (m >> 4 & 0x0f0), (m >> 4 & 0xf) | (m & 0xf0), ((m & 0xf) << 4) | (m & 0xf), 1)) // #f00
    ...
    : (m = regexps.reHslPercent.exec(string)) ? hsla(m[1], m[2] / 100, m[3] / 100, 1) // hsl(120, 50%, 50%)
